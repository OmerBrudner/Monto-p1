...
import { spanIsSampled, spanToJSON, defineIntegration, getRootSpan, getCurrentScope, getIsolationScope } from '@sentry/core';
import { timestampInSeconds, uuid4, addNonEnumerableProperty, generatePropagationContext, isPlainObject, dateTimestampInSeconds, logger, getGlobalSingleton, GLOBAL_OBJ, parseSemver, forEachEnvelopeItem, createEnvelope, dsnToString, LRUMap } from '@sentry/utils';
...
class ContinuousProfiler {constructor() { ContinuousProfiler.prototype.__init.call(this);ContinuousProfiler.prototype.__init2.call(this);ContinuousProfiler.prototype.__init3.call(this); }
   ...
   */
   _flush(chunk) {
    ...
    const envelope = makeProfileChunkEnvelope(chunk, _optionalChain([metadata, 'optionalAccess', _12 => _12.sdk]), tunnel, dsn);
   ...
   */
   _assignThreadIdContext(event) {
    if (!_optionalChain([event, 'optionalAccess', _13 => _13['contexts'], 'optionalAccess', _14 => _14['profile']])) {
      return;
    }
    ...
    event.contexts['trace'] = {
      ...(_nullishCoalesce(_optionalChain([event, 'access', _15 => _15.contexts, 'optionalAccess', _16 => _16['trace']]), () => ( {}))),
      data: {
        ...(_nullishCoalesce(_optionalChain([event, 'access', _17 => _17.contexts, 'optionalAccess', _18 => _18['trace'], 'optionalAccess', _19 => _19['data']]), () => ( {}))),
